...
export const QUIZZ_OFFICIAL.DATA: PcmQuestion[] = [
  {
    ...
    answers: [
      ...
      { id: 'base1-rebe', type: Personality.REBELLE, label: "Trouver des solutions créatives avec enthousiasme" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base2-rebe', type: Personality.REBELLE, label: "Sont spontanées, créatives et aiment s'amuser" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base3-rebe', type: Personality.REBELLE, label: "Créatif(ve)" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base4-rebe', type: Personality.REBELLE, label: "Manifester mon mécontentement face à l'inefficacité des autres" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base5-rebe', type: Personality.REBELLE, label: "La spontanéité et le plaisir de partager des moments fun" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base6-rebe', type: Personality.REBELLE, label: "Provoquer une réaction pour briser la monotonie" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base7-rebe', type: Personality.REBELLE, label: "Le jeu et la créativité" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base8-rebe', type: Personality.REBELLE, label: "Mon côté joueur, créatif, qui s'ennuyait vite" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base9-rebe', type: Personality.REBELLE, label: "Mon sens de l'humour et ma spontanéité" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base10-rebe', type: Personality.REBELLE, label: "Je rejette la faute sur les règles ou sur les autres" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy11-rebe', type: Personality.REBELLE, label: "Essayer de bien faire, mais avec difficulté face à la routine" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy12-rebe', type: Personality.REBELLE, label: "On s'amuse ensemble et qu'on partage des moments de jeu" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy13-rebe', type: Personality.REBELLE, label: "Un endroit animé, original et plein de vie" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy14-rebe', type: Personality.REBELLE, label: "Apporter de la créativité et de la légèreté" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy15-rebe', type: Personality.REBELLE, label: "Trop désinvolte ou imprévisible" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy16-rebe', type: Personality.REBELLE, label: "Celui/celle qui apporte les idées les plus originales" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy17-rebe', type: Personality.REBELLE, label: "Stimulations constantes et de nouveauté" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy18-rebe', type: Personality.REBELLE, label: "La routine et l'ennui" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy19-rebe', type: Personality.REBELLE, label: "Profiter du moment présent avec créativité" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy20-rebe', type: Personality.REBELLE, label: "Un chat (indépendant et joueur)" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase21-rebe', type: Personality.REBELLE, label: "Ma joie de vivre" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase22-rebe', type: Personality.REBELLE, label: "Avoir une liberté totale pour créer et m'amuser" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase23-rebe', type: Personality.REBELLE, label: "Je me sens étouffé(e) par des règles trop strictes" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase24-rebe', type: Personality.REBELLE, label: "Provoquer des disputes pour tester les limites" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase25-rebe', type: Personality.REBELLE, label: "Les arts, les jeux ou la culture alternative" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase26-rebe', type: Personality.REBELLE, label: "L'élève original(e) et drôle" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase27-rebe', type: Personality.REBELLE, label: "La spontanéité, la créativité et le plaisir" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase28-rebe', type: Personality.REBELLE, label: "Est inspirant, atypique et dynamique" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase29-rebe', type: Personality.REBELLE, label: "Rend l'échange vivant et original" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase30-rebe', type: Personality.REBELLE, label: "Une expérience originale et plutôt fun à réaliser" },
