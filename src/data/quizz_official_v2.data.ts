...
export const QUIZZ_OFFICIAL_V2_DATA: PcmQuestion[] = [
  {
    ...
    answers: [
      ...
      { id: 'base1-rebe', type: Personality.ENERGISEUR, label: "Ma capacité à sortir du cadre pour innover" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base2-rebe', type: Personality.ENERGISEUR, label: "Sont spontanés, créatifs et aiment l'imprévu" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base3-rebe', type: Personality.ENERGISEUR, label: "Inspirant" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base4-rebe', type: Personality.ENERGISEUR, label: "De trouver une solution détournée avec humour" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base5-rebe', type: Personality.ENERGISEUR, label: "La liberté de ton et le plaisir de travailler ensemble" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base6-rebe', type: Personality.ENERGISEUR, label: "Réagir avec sarcasme ou rejeter les règles" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base7-rebe', type: Personality.ENERGISEUR, label: "L'énergie créative" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base8-rebe', type: Personality.ENERGISEUR, label: "Je bouscule les habitudes avec des idées neuves" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base9-rebe', type: Personality.ENERGISEUR, label: "Vivante, imagée et parfois provocatrice" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'base10-rebe', type: Personality.ENERGISEUR, label: "Provoquer pour voir si l'on va me tenir tête" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy11-rebe', type: Personality.ENERGISEUR, label: "L'organisation d'ateliers créatifs et ludiques" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy12-rebe', type: Personality.ENERGISEUR, label: "On a pris du plaisir à le réaliser de façon originale" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy13-rebe', type: Personality.ENERGISEUR, label: "Un espace atypique avec une décoration inspirante" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy14-rebe', type: Personality.ENERGISEUR, label: "M'amuse à tester les limites de l'outil avec curiosité" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy15-rebe', type: Personality.ENERGISEUR, label: "Manquer de sérieux dans les moments critiques" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy16-rebe', type: Personality.ENERGISEUR, label: "Relance la dynamique par une remarque décalée" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy17-rebe', type: Personality.ENERGISEUR, label: "Participer à une activité fun et imprévue" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy18-rebe', type: Personality.ENERGISEUR, label: "La routine étouffante et le manque d'idées" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy19-rebe', type: Personality.ENERGISEUR, label: "La liberté de créer et de me réinventer" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'energy20-rebe', type: Personality.ENERGISEUR, label: "Le département innovation (créatif et disruptif)" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase21-rebe', type: Personality.ENERGISEUR, label: "Mon esprit libre" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase22-rebe', type: Personality.ENERGISEUR, label: "Un entrepreneur ayant lancé des projets originaux" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase23-rebe', type: Personality.ENERGISEUR, label: "L'ennui et le manque de fun deviennent insupportables" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase24-rebe', type: Personality.ENERGISEUR, label: "Devenir provocateur ou ENERGISEUR aux consignes" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase25-rebe', type: Personality.ENERGISEUR, label: "L'originalité de la forme et le plaisir visuel" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase26-rebe', type: Personality.ENERGISEUR, label: "L'étudiant qui mettait l'ambiance et animait les soirées" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase27-rebe', type: Personality.ENERGISEUR, label: "Être inventif et savoir surprendre" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase28-rebe', type: Personality.ENERGISEUR, label: "Le droit à l'erreur et à la fantaisie" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase29-rebe', type: Personality.ENERGISEUR, label: "Il est unique, coloré ou vraiment différent" },
  ...
  },
  {
    ...
    answers: [
      ...
      { id: 'phase30-rebe', type: Personality.ENERGISEUR, label: "M'amuser à découvrir mon profil de façon ludique" },
